const {
  ...
  describe("Lock", function () {
    ...
    beforeEach(async function () {
     ...
     await contractERC20.approve(contractVeEqual.target, valueInWei(10000));
    ...
    it("Accept offer veEqual, pay it and check rollover", async () => {
        ...
        const tx = await contractOffersV2.connect(holderEQUAL).acceptOfferAsBorrower(100, veEqualID); 
        ...
        checkData(data2, [1, 5], [[1010, 1],  valueInWei(1010)]);
